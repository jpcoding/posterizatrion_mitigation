...
mpirun -n {mpi_nps} $test --mpidims {" ".join(str(x) for x in mpi_dims )}  -m rel -e $eb --dir $data_dir  --outdir $out_dir --prefix vx --origdims 4096 4096 4096 --use_rbf 0 --local_edt 1 --local_quant 0
done
done 
