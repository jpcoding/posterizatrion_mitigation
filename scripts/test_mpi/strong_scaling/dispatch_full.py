...
test="../../../install/bin/test_mpi/test_exact_parallel"
...
mpirun -n {mpi_nps} $test --mpidims {" ".join(str(x) for x in mpi_dims )}  -m rel -e  $eb --dir $data_dir  --outdir $out_dir --prefix vx --origdims 4096 4096 4096 --use_rbf 0
done
done 
...
eb_list = [0.001] 
job_names = ["full_8x8x8", "full_8x8x4", "full_8x4x4", "full_4x4x4"] 
