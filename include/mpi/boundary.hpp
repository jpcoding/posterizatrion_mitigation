...
template <typename T_quant, typename T_boundary>
void get_boundary3d_local(T_quant* w_quant_inds, T_boundary* boundary,  int* w_dims,
                                 size_t* w_strides, int* orig_dims, size_t* orig_strides, int* mpi_coords,
                                 int* mpi_dims, MPI_Comm& cart_comm) {
    size_t w_offset;
    size_t orig_idx;
...
template <typename T_quant, typename T_boundary>
void get_boundary_and_sign_map3d_local(T_quant* w_quant_inds, T_boundary* boundary, T_boundary* sign_map, int* w_dims,
                                 size_t* w_strides, int* orig_dims, size_t* orig_strides, int* mpi_coords,
                                 int* mpi_dims, MPI_Comm& cart_comm) {
    size_t w_offset;
    size_t orig_idx;
