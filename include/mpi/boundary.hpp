...
template <typename T_quant, typename T_boundary>
void get_boundary_and_sign_map3d(T_quant* w_quant_inds, T_boundary* boundary, T_boundary* sign_map, int* w_dims, size_t* w_strides, int* orig_dims,
                    size_t* orig_strides, int* mpi_coords, int* mpi_dims, MPI_Comm& cart_comm) {
    size_t w_offset;
    size_t orig_idx;
    int starts[3] = {0, 0, 0};
...
// template <typename T_boundary, typename T_data>
// void complete_sign_map3d<T_boundary, T_data>(T_boundary* sign_map, T_data* compensation_map, T_data b_tag, size_t block_size) {
//     // for (size_t i = 0; i < block_size; i++) {
//     //     if (sign_map[i] == b_tag) {
//     //         compensation_map[i] = sign_map[i] * compensation_map[i]; 
//     //     } else {
//     //         sign_map[i] = 0; 
//     //     }
//     // }
